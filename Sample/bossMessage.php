...
$sql = "select * from work order by title, imp ;";
...
while (	$rs=mysqli_fetch_assoc($result)) {
  ...
  if($rs['imp']== 'normal'){
	...
	echo "<td><br><a href='workComplete.php?id={$rs['id']}'>CloseFile</a></td>";
...
<a href="bossMessagebystat.php">List by Emergency type</a><br>
